...
class InstructorSerializer(serializers.ModelSerializer):
    class Meta:
        model = Instructor
        fields = ('instructor_id', 'name', 'email', 'instructor_image')
...
class CourseSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Course
        fields = ('course_id', 'name', 'status', 'course_description', 'instructor')
...
class StudentEnrollmentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'course', 'student', 'student_grade', 'letterGrade')
